...
def draw_map():
    ...
    Text3 = FONT.render('5', True, BLACK)
    Text4 = FONT.render('10', True, BLACK)
    Text5 = FONT.render('30', True, BLACK)
    Text6 = FONT.render('50', True, BLACK)
    Text7 = FONT.render('4', True, BLACK)
    ...
    myscreen.blit(Text5, (682, 465))
    myscreen.blit(Text6, (682, 545))
    myscreen.blit(Text7, (755, 305))
    myscreen.blit(Text8, (755, 385))
    myscreen.blit(Text9, (755, 465))
    myscreen.blit(Text10, (755, 545))
...
def pygame_mainloop():
    pygame.init()
    pygame.display.set_caption("Random Tower Defense v1.0 updated 2022-12-08")
    draw_map()
    global life
    global gold
    global lv
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type==pygame.MOUSEBUTTONDOWN and event.button==1 and buy and not sell:
                ...
                if Button1.rect.collidepoint(event.pos) and gold>=50:
                    Button1.active()
                    buy=True
    ...
    while running1:
        ...
        Button2.draw()
        Button3.draw()
        myscreen.blit(Result, (300, 260))
        myscreen.blit(Life, (300, 300))
        pygame.display.update()
    pygame.quit()
